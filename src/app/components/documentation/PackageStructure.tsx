...
export const PackageStructure = () => {
  ...
  return (
    <div id="structure" className="md:scroll-m-[130px] scroll-m-28 relative z-10 before:absolute before:w-1/2 before:h-1/2 before:bg-linear-to-br before:from-primary before:to-secondary before:blur-390 before:z-0 before:-left-36">
                          ...
                          <div className="flex">
                            <div className="flex flex-col justify-between gap-2 mt-2">
                              {Counts.slice(0, 22).map((item) => {
                                return <p key={item} className="text-xl text-white">|</p>;
                              })}
                            </div>
                                  ...
                                  <ul className="ps-5 md:ps-12 list-unstyled red">
                                    <li className="py-2">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <span className="fs-9 text-white/60 ms-4">
                                          ...
                                          <li className="py-2">
                                            <div className="flex items-center gap-8">
                                              ...
                                              <div className="flex items-center gap-3">
                                                ...
                                                <span className="font-medium text-white/60 flex items-center flex-wrap">
                                                  <Icon
                                                    icon="tabler:folder"
                                                    className="text-primary text-base inline-block me-2"
                                                  />
