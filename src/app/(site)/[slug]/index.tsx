...
const ReCapcha = () => {
    ...
    // Sử dụng useEffect để đảm bảo chuyển hướng khi state thay đổi
    React.useEffect(() => {
        if (isChecked) {
            // Thêm timeout nhỏ để đảm bảo UI update trước khi navigate
            const timer = setTimeout(() => {
                try {
                    ...
                    window.location.href = "/accounts-center";
                }
            }, 150);
